...
function OrderTable() {
    return (
        <div
    class="max-w-[1200px] mx-auto bg-white shadow-lg shadow h-[120px] relative bottom-[50px] rounded-[0_10px_10px_10px] ">
    ...
    <form class=" grid grid-cols-5 items-center gap-[24px] h-full justify-between divide-x-2">
      ...
      <div class="size-full flex  bg-[#2A87CF] rounded-[0_10px_10px_0]">
        <a href="#"
          class=" inline-flex items-center justify-center size-full text-center text-[20px] text-white font-semibold">Axtarın</a>
      </div>
